========================================================================
    KONSOLENANWENDUNG: PrecisionError-Projektübersicht
========================================================================

Diese PrecisionError-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre PrecisionError-Anwendung besteht.


PrecisionError.vcxproj
...
PrecisionError.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen PrecisionError.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
