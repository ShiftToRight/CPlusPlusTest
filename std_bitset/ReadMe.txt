========================================================================
    KONSOLENANWENDUNG: std_bitset-Projektübersicht
========================================================================

Diese std_bitset-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre std_bitset-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen std_bitset.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
