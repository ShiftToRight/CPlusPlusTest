========================================================================
    KONSOLENANWENDUNG: builtinliterale-Projektübersicht
========================================================================

Diese builtinliterale-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre builtinliterale-Anwendung besteht.


builtinliterale.vcxproj
...
builtinliterale.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen builtinliterale.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
