========================================================================
    KONSOLENANWENDUNG: Exploring_std_string-Projektübersicht
========================================================================

Diese Exploring_std_string-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Exploring_std_string-Anwendung besteht.


Exploring_std_string.vcxproj
...
Exploring_std_string.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Exploring_std_string.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
