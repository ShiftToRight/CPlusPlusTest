========================================================================
    KONSOLENANWENDUNG: std_variant-Projektübersicht
========================================================================

Diese std_variant-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre std_variant-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen std_variant.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
