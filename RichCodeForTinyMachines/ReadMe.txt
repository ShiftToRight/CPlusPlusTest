========================================================================
    KONSOLENANWENDUNG: RichCodeForTinyMachines-Projektübersicht
========================================================================

Diese RichCodeForTinyMachines-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre RichCodeForTinyMachines-Anwendung besteht.


RichCodeForTinyMachines.vcxproj
...
RichCodeForTinyMachines.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen RichCodeForTinyMachines.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
